...
import { Emotion } from '../../../models/entry-trype.models';
import { BookSelectors, BookState } from '../../../../book';
...
export class EmotionComponent implements OnInit, AfterViewInit {
  @Input() entryTypeData!: Emotion;
  @Output() entryTypeDataChange = new EventEmitter<Emotion>();
  ...
  onValueChange(event: Event): void {
    ...
    if (newValue) {
      const newEntryTypeData: Emotion = {
        id: this.id,
